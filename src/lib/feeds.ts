export const RSS_FEEDS: Array<{ name: string; xmlUrl: string; htmlUrl: string }> = [
  ...
  { name: "blog.python.org", xmlUrl: "https://blog.python.org/rss.xml", htmlUrl: "https://blog.python.org" },
  { name: "planetpython.org", xmlUrl: "https://planetpython.org/rss20.xml", htmlUrl: "https://planetpython.org" },
  { name: "realpython.com", xmlUrl: "https://realpython.com/atom.xml", htmlUrl: "https://realpython.com" },
  { name: "pythonspeed.com", xmlUrl: "https://pythonspeed.com/atom.xml", htmlUrl: "https://pythonspeed.com" },
  { name: "hynek.me", xmlUrl: "https://hynek.me/atom.xml", htmlUrl: "https://hynek.me" },
  { name: "nedbatchelder.com", xmlUrl: "https://nedbatchelder.com/blog/rss.xml", htmlUrl: "https://nedbatchelder.com" },
  { name: "snarky.ca", xmlUrl: "https://snarky.ca/feed/", htmlUrl: "https://snarky.ca" },
  { name: "duckdb.org", xmlUrl: "https://duckdb.org/feed.xml", htmlUrl: "https://duckdb.org" },
  { name: "arrow.apache.org", xmlUrl: "https://arrow.apache.org/feed.xml", htmlUrl: "https://arrow.apache.org" },
  { name: "timescale.com", xmlUrl: "https://blog.timescale.com/feed", htmlUrl: "https://www.timescale.com/blog" },
  { name: "influxdata.com", xmlUrl: "https://www.influxdata.com/blog/feed/", htmlUrl: "https://www.influxdata.com/blog" },
  { name: "clickhouse.com", xmlUrl: "https://clickhouse.com/rss.xml", htmlUrl: "https://clickhouse.com/blog" },
  { name: "pola.rs", xmlUrl: "https://pola.rs/rss.xml", htmlUrl: "https://pola.rs" },
  { name: "github-trending-python-daily", xmlUrl: "https://mshibanami.github.io/GitHubTrendingRSS/daily/python.xml", htmlUrl: "https://github.com/trending/python" },
  { name: "github-trending-jupyter-weekly", xmlUrl: "https://mshibanami.github.io/GitHubTrendingRSS/weekly/jupyter-notebook.xml", htmlUrl: "https://github.com/trending/jupyter-notebook?since=weekly" },
